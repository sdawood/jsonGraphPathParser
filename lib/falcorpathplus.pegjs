...
CHILD_MEMBER_COMPONENT
  = DOT member:MEMBER_EXPRESSION { return [ ast("CHILD_MEMBER_COMPONENT").set(jp["member-child-identifier"]({ expression: { value: member } })) ]; }
...
SUBSCRIPT_COMPONENT
  = subscript:CHILD_SUBSCRIPT_COMPONENT { return subscript; }
