...
SUBSCRIPT_COMPONENT
  = subscript:CHILD_SUBSCRIPT_COMPONENT { return subscript; } //subscript-componenet is already a list of subscript expressions, meets unroll expectations
...
SUBSCRIPT_EXPRESSION_LIST =
  ...
  {
    var result = unroll(first, rest, 3);
...
SUBSCRIPT_EXPRESSION_LISTABLE
  ...
  / range:Range { return ast("SUBSCRIPT_EXPRESSION_LISTABLE").set(jp['subscript-child-slice']({expression: { value: range}})); }
  / int:INTEGER { return ast("SUBSCRIPT_EXPRESSION_LISTABLE").set(jp["subscript-child-numeric_literal"]({ expression: { value: int } })); }
  / str:StringLiteral { return ast("SUBSCRIPT_EXPRESSION_LISTABLE").set(jp["subscript-child-string_literal"]({ expression: { value: str } })); }
